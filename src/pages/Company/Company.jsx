  ...
  return (
    <div className='Company__container'>
        ...
        <table border="1" className="gold-table">
            <thead>
                <tr>
                <th className="gold-light-opacity">{ lang === "latin" ? "NAZIV FIRME" : "НАЗИВ ФИРМЕ"}</th>
                <th className="gold-medium-opacity">{ lang === "latin" ? "ADRESA" : "АДРЕСА"}</th>
                <th className="gold-dark-opacity">{ lang === "latin" ? "BROJ RATA" : "БРОЈ РАТА"}</th>
                {user && <th className="gold-darkest-opacity">{ lang === "latin" ? "UGOVOR" : "УГОВОР"}</th>}
                </tr>
            </thead>
            <tbody>
